...
classifier_urls = [
    ...
    'https://drive.google.com/uc?id=1GYf1Mxcq-Ajxuc_A5GO6hW4J6b7nE_LF', # celebahq-classifier-27-no-beard.pkl
...
#         np.save('results/8_score.npy', results[8][:, 0].reshape((-1,1)))
        np.save('results/27_score.npy', results[27][:, 0].reshape((-1,1)))
